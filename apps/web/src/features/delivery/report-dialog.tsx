        ...
        <div className="bg-muted/50 p-5">
          ...
          <article className="mx-auto rounded-xl border border-border bg-card p-8 shadow-card">
            ...
            <section className="grid grid-cols-2 gap-3 py-5 sm:grid-cols-5">
              {data.kpis.map((k) => (
                <div key={k.key}>
                  ...
                  <div className="text-subheading font-semibold tabular">{fmtKpi(k)}</div>
                  <div className={k.delta >= 0 ? "text-body text-success" : "text-body text-danger"}>
            ...
            <section className="grid gap-6 border-t border-border py-5 sm:grid-cols-2">
              ...
              <div>
                <h3 className="text-body font-semibold uppercase tracking-wider text-muted-foreground">Deliverables</h3>
                {cycle ? (
                  <>
                    <div className="mt-2 text-heading font-semibold tabular">
                      {delivered}
                      <span className="text-subheading font-normal text-muted-foreground"> of {cycle.promised} approved</span>
                    </div>
                  ...
                  <p className="mt-2 text-body text-muted-foreground">No active cycle.</p>
                )}
              </div>
            </section>

            <section className="border-t border-border py-5">
              <h3 className="text-body font-semibold uppercase tracking-wider text-muted-foreground">Top content</h3>
